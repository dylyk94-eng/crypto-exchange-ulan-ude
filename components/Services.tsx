const serviceGroups = [
  {
    ...
    description:
      'Работаем с популярными активами и оперативно организовываем сделку.',
    points: ['USDT, BTC, ETH, SOL', 'Наличные расчеты', 'Сопровождение до завершения'],
  },
  {
    title: 'Международные расчеты',
    description:
      'Помогаем закрыть платежи за услуги, товары, недвижимость и частные задачи.',
    points: ['Таиланд (недвижимость), Китай (WeChat, Alipay)', 'Консультация по маршруту оплаты', 'Сопровождение нестандартных кейсов'],
  },
  {
...
const process = [
  ...
  ['Согласование', 'Подтверждаем сумму, город и удобный формат. Курс фиксируется на месте.'],
